...
public class TaxInformation {
    ...
    public TaxInformation(Invoice invoice, Issuer issuer) {
        this.ambiente="123456789";
        this.tipoEmision="1";
        this.razonSocial=issuer.getSocialReason();
        this.nombreComercial=issuer.getName();
        this.ruc=issuer.getRuc();
        this.claveAcceso=invoice.getAccesKey();
        this.codDoc="123444432";
        this.estab="02";
        this.ptoEmi="01";
        this.secuencial="0123456789";
        this.dirMatriz=issuer.getAddres();
    }

   public TaxInformation(String keyAcces,Issuer issuer,String ambiente,String tipoEmision,String codDoc,String estab,String ptoEmision,String secuencial){
       this.claveAcceso=keyAcces;
